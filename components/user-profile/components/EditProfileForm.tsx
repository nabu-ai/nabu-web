...
const EditProfileForm = ({onSuccess}) => {
  ...
  const { id, firstName, lastName, phoneCode, phoneNumber, city, state, postalCode, country } = userData;
  ...
  const onSubmit = async (data: z.infer<typeof ProfileUpdateSchema>) => {
    const { id, firstName, lastName, phoneCode, phoneNumber, city, state, postalCode, country } = data;
    handleUpdateProfile({ id, firstName, lastName, phoneCode, phoneNumber, city, state, postalCode, country });
  };
