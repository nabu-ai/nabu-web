...
export default function UserInfoCard({userInfo}) {
  ...
  const {firstName, lastName, email, phoneCode, phoneNumber} = userInfo || {};
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
            ...
            <div>
              ...
              <p className="text-theme-xl font-medium text-gray-800 dark:text-white/90 overflow-text-wrap">
                 {email}
              </p>
            </div>
